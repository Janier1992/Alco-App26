import{G as l}from"./vendor-core-BSb7b0RV.js";import"./vendor-react-E_fSL5Nh.js";const i="AIzaSyA5QqOGhud-GOyCdokpneK3wo3F-e7kP88";let t=null;try{t=new l(i)}catch(n){console.error("Error al inicializar GoogleGenerativeAI:",n)}const s=async(n="gemini-1.5-flash",r)=>{if(!t)return console.error("GoogleGenerativeAI no está inicializado. Verifica tu API Key."),null;try{return(await(await t.getGenerativeModel({model:n}).generateContent(r)).response).text()}catch(e){return console.error(`Error generando contenido con ${n}:`,e),null}},d=async(n,r)=>{const e=`
