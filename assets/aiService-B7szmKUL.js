import{G as i}from"./index-C1C8HYXU.js";const l="AIzaSyAao48NBXbU0Kqwp8vJJl7J3I4vU4sRKO4";let t=null;try{t=new i(l)}catch(n){console.error("Error al inicializar GoogleGenerativeAI:",n)}const s=async(n="gemini-1.5-flash",r)=>{if(!t)return console.error("GoogleGenerativeAI no está inicializado. Verifica tu API Key."),null;try{return(await(await t.getGenerativeModel({model:n}).generateContent(r)).response).text()}catch(e){return console.error(`Error generando contenido con ${n}:`,e),null}},u=async(n,r)=>{const e=`
