import{G as s}from"./vendor-core-C3XopWI3.js";import"./vendor-react-UlIMTZ8g.js";const l="AIzaSyAao48NBXbU0Kqwp8vJJl7J3I4vU4sRKO4";let t=null;try{t=new s(l)}catch(e){console.error("Error al inicializar GoogleGenerativeAI:",e)}const i=async(e="gemini-1.5-flash",n)=>{if(!t)return console.error("GoogleGenerativeAI no está inicializado. Verifica tu API Key."),null;try{return(await(await t.getGenerativeModel({model:e}).generateContent(n)).response).text()}catch(r){return console.error(`Error generando contenido con ${e}:`,r),null}},d=async(e,n)=>{const r=`
